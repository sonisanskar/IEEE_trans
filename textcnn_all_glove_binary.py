...
data_train=train_df[:200]
data_test=train_df[500:550]
...
data_train=pd.read_csv('../input/binary-sst2-dataset/train.csv')
data_test=pd.read_csv('../input/binary-sst2-dataset/test.csv')
...
sns.countplot(data_train['no_of_words_in_paragraph'])
# In[ ]:
import seaborn as sns
sns.boxplot(data_train['no_of_words_in_paragraph'])
